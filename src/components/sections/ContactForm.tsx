...
const input = 'w-full px-4 py-3 text-sm text-slate-900 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition placeholder:text-slate-300'
  ...
  if (submitted) {
    return (
      <div className="bg-slate-50 border border-slate-100 rounded-xl p-10 text-center">
        ...
        <button onClick={() => setSubmitted(false)} className="mt-6 text-sm text-brand font-medium hover:text-brand-dark transition-colors">
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="firstName" className="block text-sm font-medium text-slate-600 mb-1.5">First Name <span className="text-brand">*</span></label>
        ...
        <div>
          <label htmlFor="lastName" className="block text-sm font-medium text-slate-600 mb-1.5">Last Name <span className="text-brand">*</span></label>
      ...
      <div>
        <label htmlFor="email" className="block text-sm font-medium text-slate-600 mb-1.5">Email Address <span className="text-brand">*</span></label>
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-slate-600 mb-1.5">Message <span className="text-brand">*</span></label>
      ...
      <button type="submit" disabled={loading} className="w-full sm:w-auto inline-flex items-center justify-center px-7 py-3.5 text-sm font-semibold text-white bg-slate-900 hover:bg-brand disabled:opacity-60 disabled:cursor-not-allowed rounded-lg transition-colors">
        {loading ? (
