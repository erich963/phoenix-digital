    ...
    <>
      ...
      <section className="bg-white border-b border-gray-100 py-32 lg:py-40" style={pad}>
        <div className="max-w-3xl">
          <p className="text-brand font-medium text-sm tracking-wide uppercase mb-4">Strategic Sessions</p>
      ...
      {/* Scope Note */}
      <section className="bg-gray-50 border-b border-gray-100 py-10 lg:py-12" style={pad}>
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-gray-100" style={pad}>
        <div className="mb-14">
          <p className="text-brand font-medium text-sm tracking-wide uppercase mb-3">Areas of Focus</p>
          <h2 className="text-heading text-slate-800">Six categories of senior-level advisory</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {strategyCategories.map((cat) => (
            <div key={cat.title} className="border border-gray-200 rounded-xl p-7">
              <div className="w-8 h-0.5 bg-brand mb-5 rounded-full" />
              <h3 className="text-base font-semibold text-slate-800 mb-2">{cat.title}</h3>
      ...
      <section className="bg-gray-50 border-b border-gray-100 py-20 lg:py-28" style={pad}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h2 className="text-heading text-slate-800 mb-6">Built for operators who need answers, not ambiguity</h2>
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-gray-100" style={pad}>
        <div className="mb-14">
          <p className="text-brand font-medium text-sm tracking-wide uppercase mb-3">Session Formats</p>
          <h2 className="text-heading text-slate-800">Choose the format that fits your need</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {sessionFormats.map((format) => (
            <div key={format.title} className="border border-gray-200 rounded-xl p-8">
              <div className="w-8 h-0.5 bg-brand mb-5 rounded-full" />
              <h3 className="text-lg font-semibold text-slate-800 mb-3">{format.title}</h3>
      ...
      <section className="bg-white py-20 lg:py-28" style={pad}>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-heading text-slate-800 mb-5">Have a specific problem to work through?</h2>
