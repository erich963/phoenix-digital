    ...
    <>
      ...
      <section className="bg-slate-900 py-32 lg:py-40" style={pad}>
        <div className="max-w-3xl">
          <p className="text-brand-light font-medium text-sm tracking-wide uppercase mb-4">Strategic Sessions</p>
      ...
      {/* Scope Note */}
      <section className="bg-brand-subtle border-b border-slate-100 py-10 lg:py-12" style={pad}>
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-slate-100" style={pad}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {sessionFormats.map((format) => (
            <div key={format.title} className="border border-slate-200 rounded-xl p-8">
              <div className="w-8 h-0.5 bg-brand mb-5 rounded-full" />
