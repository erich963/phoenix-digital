  ...
  return (
    <section className="bg-white py-20 lg:py-28" style={sectionPad}>
      <div className="max-w-3xl">
        <p className="text-xs font-semibold uppercase tracking-widest text-[#2d2d2d]/50 mb-4">Legal</p>
        <h1 className="text-4xl font-semibold text-[#0a0a0a] mb-4">
          Privacy Policy
        </h1>
        <p className="text-sm text-[#2d2d2d]/50 mb-12">Last updated: March 2025</p>

        <div className="space-y-10">

          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Overview</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Information We Collect</h2>
            <p className="text-[#2d2d2d]/70 leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside text-[#2d2d2d]/70 space-y-1 leading-relaxed">
              <li>Name</li>
              <li>Email address</li>
              <li>Company name</li>
              <li>Message content</li>
            </ul>
            <p className="text-[#2d2d2d]/70 leading-relaxed mt-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">How We Use Your Information</h2>
            <p className="text-[#2d2d2d]/70 leading-relaxed mb-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Third-Party Services</h2>
            <p className="text-[#2d2d2d]/70 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Data Retention</h2>
            <p className="text-[#2d2d2d]/70 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Changes to This Policy</h2>
            <p className="text-[#2d2d2d]/70 leading-relaxed">
          ...
          <div>
            ...
            <p className="text-[#2d2d2d]/70 leading-relaxed">
              ...
              <a href="/contact" className="text-[#0a0a0a] hover:text-[#2a2a2a] font-medium underline">
                contact form
              </a>{' '}
              on our Site.
            </p>
