    ...
    <>
      ...
      <section className="bg-white border-b border-slate-200 py-20 sm:py-28 lg:py-36" style={pad}>
        <div className="max-w-3xl">
          <p className="text-slate-400 font-medium text-sm tracking-wide uppercase mb-3">Paid Search</p>
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-slate-200" style={pad}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {commonProblems.map((p) => (
            <div key={p.label} className="border border-slate-200 rounded-xl p-7">
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-slate-200" style={pad}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={item.title} className="border border-slate-200 rounded-xl p-7">
