    ...
    <>
      ...
      <section className="bg-white border-b border-slate-200 py-32 lg:py-40" style={pad}>
        <div className="max-w-3xl">
          <p className="text-slate-400 font-medium text-sm tracking-wide uppercase mb-4">Paid Search</p>
      ...
      <section className="bg-slate-100 border-b border-slate-200 py-20 lg:py-28" style={pad}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h2 className="text-heading text-slate-800 mb-6">Built for B2B businesses with real lead value</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item} className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-5">
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-slate-200" style={pad}>
        <div className="mb-14">
          <p className="text-slate-400 font-medium text-sm tracking-wide uppercase mb-3">Common Problems We Solve</p>
          <h2 className="text-heading text-slate-800 max-w-lg">Why most B2B Google Ads accounts underperform</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {commonProblems.map((p) => (
            <div key={p.label} className="border border-gray-200 rounded-xl p-6">
              <h3 className="text-base font-semibold text-slate-800 mb-2">{p.label}</h3>
      ...
      <section className="bg-slate-100 border-b border-slate-200 py-20 lg:py-28" style={pad}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h2 className="text-heading text-slate-800 mb-6">Full-service management, clearly scoped</h2>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {included.map((item) => (
              <div key={item} className="flex items-center gap-2.5 bg-white border border-gray-200 rounded-lg px-4 py-3">
      ...
      <section className="bg-white py-20 lg:py-28 border-b border-slate-200" style={pad}>
        <div className="max-w-2xl mb-12">
          <p className="text-slate-400 font-medium text-sm tracking-wide uppercase mb-3">Our Approach</p>
          <h2 className="text-heading text-slate-800">Designed around pipeline, not clicks</h2>
        </div>
      ...
      <section className="bg-white py-20 lg:py-28" style={pad}>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-heading text-slate-800 mb-5">Get a clearer view of what your paid search should be doing.</h2>
